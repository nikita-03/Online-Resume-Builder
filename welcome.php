    ...
    <div class="container" id="cv-form">
        <div class="row">
            <div class="col-md-6 mt-3">
                ...
                <div class="form-group mt-2">
                    <label for="fbField">Facebook Profile</label>
                    <input type="text" id="fbField" name="fbField" placeholder="Enter Here" class="form-control">
                </div>

                <div class="form-group mt-2">
                    <label for="instaField">Instagram Profile</label>
                    <input type="text" id="instaField" name="instaField" placeholder="Enter Here" class="form-control">
                </div>
        ...
        <div class="row mt-5">
            <div class="col-md-4  text-center py-3 background">
                ...
                <div class="container">
                    ...
                    <p>
                        <a id="fbT" href="https://www.facebook.com">Facebook</a>
                    </p>
                    <p>
                        <a id="instaT" href="https://www.instagram.com/">Instagram</a>
                    </p>
                    <p>
